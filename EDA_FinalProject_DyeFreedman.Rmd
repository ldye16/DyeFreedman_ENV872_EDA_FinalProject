...
#Completing the same process of splitting the data into years, grouping by individual Pika tag IDs, and finding yearing means. This time for fleas sampled, rather than fleas observed. 
...
#Total Flea Samples by year within climate data range
