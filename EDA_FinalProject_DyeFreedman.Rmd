...
Mean_Pika_Location_sf2 <- Mean_Pika_Location %>% 
  st_as_sf(coords = c('Mean_Easting','Mean_Northing'),
           crs=2151) %>%
  filter(Year == 2018 | 
         Year == 2008)
...
mapview(Mean_Pika_Location_sf) %>%
  leafem::addStaticLabels(label = Mean_Pika_Location_sf$Year,
                  noHide = TRUE,
                  direction = "left",
                  textOnly = TRUE,
                  textsize = "20px") + 
  mapview(Mean_Pika_Location_sf2) %>%
  leafem::addStaticLabels(label = Mean_Pika_Location_sf2$Year,
                  noHide = TRUE,
                  direction = "right",
                  textOnly = TRUE,
                  textsize = "20px")
